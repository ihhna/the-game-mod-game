...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("the_game_of_mod_game", "modelcustom_model"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headwear2 = partdefinition.addOrReplaceChild("headwear2",
				CubeListBuilder.create().texOffs(30, 47).addBox(-8.0F, -8.0F, -6.0F, 16.0F, 16.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition bodywear = partdefinition.addOrReplaceChild("bodywear",
				...
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition arms = partdefinition
				.addOrReplaceChild("arms",
						CubeListBuilder.create().texOffs(44, 22).addBox(-8.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
								.texOffs(40, 38).addBox(-4.0F, 2.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 2.0F, 0.0F));
		PartDefinition arms_flipped = arms.addOrReplaceChild("arms_flipped", CubeListBuilder.create().texOffs(44, 22).mirror()
				.addBox(-2.0F, -4.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(6.0F, 2.0F, 0.0F));
